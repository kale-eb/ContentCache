...
declare global {
  interface Window {
    electronAPI: {
      ...
      generateThumbnail: (filePath: string, contentType?: string) => Promise<string | null>
      openFile: (filePath: string) => Promise<void>
      revealFile: (filePath: string) => Promise<void>
      onFilesSelected: (callback: (event: any, filePaths: string[]) => void) => () => void
      onFolderSelected: (callback: (event: any, folderPath: string) => void) => () => void
      onPythonOutput: (callback: (event: any, data: string) => void) => () => void
      onPythonError: (callback: (event: any, data: string) => void) => () => void
      onSearchServerOutput: (callback: (event: any, data: string) => void) => () => void
      onSearchServerError: (callback: (event: any, data: string) => void) => () => void
